 ...
 */
export const elementInView = (element, partial = true) => {
    // Error stuff
    if (!element)
        throw new Error("Parameter one is required");
    if (!(element instanceof HTMLElement))
        throw new Error("Parameter one must be an instance of HTMLElement");
    if (typeof partial !== "boolean")
        throw new Error("Parameter 2 must be a boolean");
